System.register(['angular2/core', 'angular2/router', './heroes/heroes.component', './heroes/hero-detail.component', './dashboard/dashboard.component', './heroes/hero.service'], function(exports_1, context_1) {
    "use strict";
